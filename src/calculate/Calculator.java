...
* Write the logic in calculateResult method that when user enter first number
* and second number and symbol based on symbol it does calculate.
...
* Please enter one of symbol +,-,*, /:” if user enter + symbol result like
